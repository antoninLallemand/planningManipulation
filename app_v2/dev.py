...
class MainUI(QtWidgets.QMainWindow):
    ...
    def __init__(self):
        ...
        self.setWindowTitle("Générateur planning")
    ...
    def browse_xls(self):
        ...
        if not os.path.exists(default_folder):
            default_folder = ""
        file_name, _ = QtWidgets.QFileDialog.getOpenFileName(self, "Selectionner un planning excel", default_folder, "Fichiers Excel (*.xls *.xlsm *.xlsx)")
        if file_name:
